...
GLOBAL_LIST_INIT(elfd_names_male, world.file2list("strings/rt/names/elf/elfdm.txt"))
GLOBAL_LIST_INIT(elfd_names_female, world.file2list("strings/rt/names/elf/elfdf.txt"))
