...
/obj/item/reagent_containers/food/snacks/proc/On_Consume(mob/living/eater)
	...
	if (ishuman(eater))
		...
		if (!(HAS_TRAIT(human_eater, TRAIT_NASTY_EATER) || HAS_TRAIT(human_eater, TRAIT_WILD_EATER) || HAS_TRAIT(human_eater, TRAIT_ROT_EATER) || HAS_TRAIT(human_eater, TRAIT_ORGAN_EATER)))
