/datum/job/roguetown/sergeant
	...
	tutorial = "You are the most experienced of the Hamlet's Soldiery, leading the men-at-arms in maintaining order and attending to threats and crimes below the Consular's attention."
