/mob/living/carbon/human/species/kenku
	race = /datum/species/kenku
...
/datum/species/kenku/check_roundstart_eligible()
	return TRUE

/datum/species/kenku/qualifies_for_rank(rank, list/features)
	return TRUE

/datum/species/kenku/get_random_features()
