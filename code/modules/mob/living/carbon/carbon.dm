...
/mob/living/Stat()
	..()
	if(statpanel("Stats"))
		stat("Strenght: \Roman [STASTR]")
		stat("Perception: \Roman [STAPER]")
		stat("Intelligence: \Roman [STAINT]")
		stat("Constitution: \Roman [STACON]")
		stat("Endurance: \Roman [STAEND]")
		stat("Speed: \Roman [STASPD]")
		stat("Luck: \Roman [STALUC]")
		stat("Patron: [patron]")
