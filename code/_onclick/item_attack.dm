...
/mob/living/proc/get_attack_flavor_text(mob/user, obj/item/I) // Arguments very important. The name comes from the fact that if you don't add the right arguments, then arguments break out between you and your screen. You start screaming, "WHY DOESN'T IT WOOOOORK?!!!".
