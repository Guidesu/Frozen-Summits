/datum/advclass/mage
	name = "Wizard"
	tutorial = "Wizards are usually grown-up apprentices of elder wizards. They are seeking adventure, using their arcane knowledge to aid or ward off other adventurers."
